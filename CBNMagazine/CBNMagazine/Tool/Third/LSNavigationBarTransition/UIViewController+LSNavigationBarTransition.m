...
//    [self.navigationController.navigationBar setBackgroundImage:[[UIColor colorWithRed:0.671 green:0.384 blue:1.000 alpha:1.000] colorImage] forBarMetrics:UIBarMetricsDefault];
}
