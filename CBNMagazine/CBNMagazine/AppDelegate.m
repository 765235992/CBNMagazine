...
-(BOOL)application:(UIApplication *)application willFinishLaunchingWithOptions:(NSDictionary *)launchOptions{
     ...
     *  添加频道根视图
     */
    UIViewController *mainVC =[[CBNMainVC alloc]initWithNibName:nil bundle:nil];
    CBNMainNavigationVC *channelRootNavigationVC = [[CBNMainNavigationVC alloc]initWithRootViewController:mainVC];
